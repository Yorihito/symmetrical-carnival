...
let targetX = 512
// Finding exact dot Y center by scanning top half:
var sumY = 0
var count = 0
for y in 700...800 {
    for x in 480...540 {
...
let targetY = count > 0 ? (sumY / count) : 756
print("Actual dot center found at Y=\(targetY)")

let patchRadius = 45
// Source X: well inside the dial. 600 is safe.
let sourceX = 600
...
try! pngData.write(to: URL(fileURLWithPath: "Icon-1024-fixed.png"))
