...
| VOL-08 | Main Zoneの音量UIをスライダー／回転ダイアルから選択 | — | Must |
| VOL-09 | 回転ダイアルを0.5 dB刻みで操作し、iOSでは操作ごとに触覚フィードバックを返す | — | Must |
| VOL-10 | 既存ユーザー向けにスライダーを初期値として維持し、ダイアル紹介を接続成功後に1回だけ表示 | — | Must |
